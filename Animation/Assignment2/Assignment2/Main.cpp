...
void InitShaders(GLuint& program, cShaderManager::cShader& vertShader, cShaderManager::cShader& fragShader) {
    ...
    vertShader.fileName = "assets/shaders/boneShader_01.glsl";
...
//    ::g_pTheLights->theLights[0].param1.x = 1.0f;    // Spot light
    ...
    vecModelsToLoad.push_back("tentacle.ply");
    ...
    if (!::g_pGameEngine->g_pTextureManager->CreateCubeTextureFromBMPFiles("WinterRiver",
        "nightsky1_left.bmp",    /* posX_fileName */
        "nightsky1_right.bmp",     /*negX_fileName */
        "nightsky1_down.bmp",     /*negY_fileName*/
        "nightsky1_up.bmp",       /*posY_fileName*/
        "nightsky1_front.bmp",    /*posZ_fileName*/
        "nightsky1_back.bmp",      /*negZ_fileName*/
    ...
    ::g_pGameEngine->LoadAnimationAssignmentTwoScene();

    while (!glfwWindowShouldClose(pWindow)) {

        //::g_TitleText = "Curtis Tremblay - INFO-6045 - Assignment 2";
        float ratio;
        int width, height;
