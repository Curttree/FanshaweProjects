...
//        GLuint TextureNumber = ::g_pTextureManager->getTextureIDFromName("Fauci.bmp");
        GLuint TextureNumber = ::g_pGameEngine->g_pTextureManager->getTextureIDFromName(pCurrentMesh->textureNames[0]);
    ...
    if (pCurrentMesh->textureRatios[1] >= 0.0f)
    {
        ...
        GLuint TextureNumber = ::g_pGameEngine->g_pTextureManager->getTextureIDFromName(pCurrentMesh->textureNames[1]);
...
//        GLuint TextureNumber = ::g_pTextureManager->getTextureIDFromName("Lisse_mobile_shipyard-mal1.bmp");
        GLuint TextureNumber = ::g_pGameEngine->g_pTextureManager->getTextureIDFromName(pCurrentMesh->textureNames[2]);
...
//        GLuint TextureNumber = ::g_pTextureManager->getTextureIDFromName("Broc_tree_house.bmp");
        GLuint TextureNumber = ::g_pGameEngine->g_pTextureManager->getTextureIDFromName(pCurrentMesh->textureNames[3]);
...
//        GLuint TextureNumber = ::g_pTextureManager->getTextureIDFromName("Broc_tree_house.bmp");
        GLuint TextureNumber = ::g_pGameEngine->g_pTextureManager->getTextureIDFromName(pCurrentMesh->textureNames[4]);
        ...
        GLuint TextureNumber2 = ::g_pGameEngine->g_pTextureManager->getTextureIDFromName(pCurrentMesh->textureNames[6]);
    ...
    if (pCurrentMesh->textureRatios[5] >= 0.0f) {
        ...
        GLuint TextureNumber = ::g_pGameEngine->g_pTextureManager->getTextureIDFromName(pCurrentMesh->textureNames[5]);
        ...
        GLuint TextureNumber2 = ::g_pGameEngine->g_pTextureManager->getTextureIDFromName(pCurrentMesh->textureNames[7]);
...

    {
        ...
        if (pCurrentMesh->bUseDiscardTransparency)
        {
            ...
            GLuint discardTextureNumber = ::g_pGameEngine->g_pTextureManager->getTextureIDFromName(pCurrentMesh->textureNames[8]);
...

    {
        ...
        GLuint TextureNumber = ::g_pGameEngine->g_pTextureManager->getTextureIDFromName("WinterRiver");
...
// *****************************************************
    ...
    // Copy the whole object colour information to the shader               
