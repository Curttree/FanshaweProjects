...
bool LoadPLYModelFromFile(std::string fileName, sModelDrawInfo& drawInfo)
{
    ...
    struct sVertex
    {
        float x, y, z;
        float nx, ny, nz;
        // Note: The models for Project 1 do not use RGB values. Leaving this line here for re-use in the future.
    ...
    for (unsigned int index = 0; index < drawInfo.numberOfVertices; index++)
    {
        ...
        //        theFile >> tempVertex.c; // Confidence. Not utilized in current model.
        //       theFile >> tempVertex.i;   // Intensity. Not utilized in current model.
        ...
        // Now load RGBA colours: (NOTE: Not used in Project 1 models. Keeping for later projects).
...
//    drawInfo.pVertices = new sVertex_XYZ_RGB[drawInfo.numberOfVertices];
    ...
    for (unsigned int index = 0; index != drawInfo.numberOfVertices; index++)
    {
        ...
        // Copy colour... Again, not used in Project 1 models so commenting out to be brought back later.
