...
cMesh::cMesh()
{
	...
	this->scale = 1.0f;
	this->nonUniformScale = glm::vec3(1.f);
	...
	this->bUseDiscardTransparency = false;
	this->bDoesReflect = false;
	this->bDoesRefract = false;
	this->refractionIndex = 1.f;

	// Specular map
	this->bUseSpecularMap = false;
	this->specularMapTexture = "";
