...
void cDungeonMaster::PlacePlants() {
	...
	cMesh* sun1 = factory->createDungeonPiece(22, glm::vec3(8150.f, 1000.f, 2400.f));
	cMesh* sun2 = factory->createDungeonPiece(22, glm::vec3(14250.f, 1000.f, 4800.f));
	cMesh* sun3 = factory->createDungeonPiece(22, glm::vec3(4650.f, 1000.f, 8450.f));
	...
	sun1->orientationXYZ = glm::vec3(-0.2f, 0.f, 0.24f);
	sun2->orientationXYZ = glm::vec3(-0.2f, 0.f, 0.33f);
	sun3->orientationXYZ = glm::vec3(-0.25f, 0.f, 0.24f);
	dungeonModels.push_back(sun1);
	dungeonModels.push_back(sun2);
	dungeonModels.push_back(sun3);
	...
	::g_pTheLights->theLights[6].position = glm::vec4(7850.f, 1500.f, 1900.f, 1.f);
	::g_pTheLights->theLights[6].direction = glm::vec4(0.2f, -1.f, 0.24f, 1.f);
	::g_pTheLights->theLights[6].diffuse = glm::vec4(1.f, 1.f, 0.8f, 1.f);
	::g_pTheLights->theLights[6].specular = glm::vec4(1.f, 1.f, 0.8f, 1.f);
	::g_pTheLights->theLights[6].atten = glm::vec4(0.0003f, 0.0000004f, 0.000001f, 2000.f);
	::g_pTheLights->theLights[6].param1.x = 1.f;    // spot light
	::g_pTheLights->theLights[6].param1.y = 10.f;
	::g_pTheLights->theLights[6].param1.z = 12.f;
	::g_pTheLights->TurnOnLight(6);

	::g_pTheLights->theLights[7].position = glm::vec4(14250.f, 1500.f, 4300.f, 1.f);
	::g_pTheLights->theLights[7].direction = glm::vec4(0.2f, -1.f, 0.33f, 1.f);
	::g_pTheLights->theLights[7].diffuse = glm::vec4(1.f, 1.f, 0.8f, 1.f);
	::g_pTheLights->theLights[7].specular = glm::vec4(1.f, 1.f, 0.8f, 1.f);
	::g_pTheLights->theLights[7].atten = glm::vec4(0.0003f, 0.0000004f, 0.000001f, 2000.f);
	::g_pTheLights->theLights[7].param1.x = 1.f;    // spot light
	::g_pTheLights->theLights[7].param1.y = 10.f;
	::g_pTheLights->theLights[7].param1.z = 12.f;
	::g_pTheLights->TurnOnLight(7);

	::g_pTheLights->theLights[8].position = glm::vec4(4350.f, 1500.f, 8400.f, 1.f);
	::g_pTheLights->theLights[8].direction = glm::vec4(0.25f, -1.f, 0.24f, 1.f);
	::g_pTheLights->theLights[8].diffuse = glm::vec4(1.f, 1.f, 0.8f, 1.f);
	::g_pTheLights->theLights[8].specular = glm::vec4(1.f, 1.f, 0.8f, 1.f);
	::g_pTheLights->theLights[8].atten = glm::vec4(0.0003f, 0.0000004f, 0.000001f, 2000.f);
	::g_pTheLights->theLights[8].param1.x = 1.f;    // spot light
	::g_pTheLights->theLights[8].param1.y = 10.f;
	::g_pTheLights->theLights[8].param1.z = 12.f;
...
void cDungeonMaster::CreateFlame(glm::vec3 position) {
	...
	if (candlesPlaced < ::g_pTheLights->NUMBER_OF_LIGHTS) {
		...
		::g_pTheLights->theLights[candlesPlaced].atten = glm::vec4(0.003f, 0.001f, 0.0027f, 400.f);
