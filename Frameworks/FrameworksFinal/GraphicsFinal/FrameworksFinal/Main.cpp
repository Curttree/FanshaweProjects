...
int main(void) {
    ...
    ::g_pTheLights->theLights[0].position = glm::vec4(0.f, 0.f, -5000.f, 1.f);
    ::g_pTheLights->theLights[0].direction = glm::vec4(0.f, 0.f, 1.f, 1.f);
    ...
    vecModelsToLoad.push_back("Invaders/SpaceInvader_I1_block_pose_1.ply");
    vecModelsToLoad.push_back("Invaders/SpaceInvader_I1_block_pose_2.ply");
    vecModelsToLoad.push_back("Invaders/SpaceInvader_I2_block_pose_1.ply");
