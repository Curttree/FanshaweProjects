...
{
	cCurtArray<std::string> vecTokens;
	...
	switch ((unsigned int)vecTokens.get_size())
	{
	case 0:
...
void cFlyCamera::m_tokenizeString(std::string theString, cCurtArray<std::string>& vecTokens)
{
