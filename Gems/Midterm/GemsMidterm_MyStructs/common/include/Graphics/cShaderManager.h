...
public:
	...
	public:
		...
		cCurtArray<std::string> vecSource;
	...
	public:
		...
		cCurtMap<std::string, int /* uniform location ID */ >
...
private:
	...
	cCurtMap< unsigned int /*ID*/, cShaderProgram > m_ID_to_Shader;
	cCurtMap< std::string /*name*/, unsigned int /*ID*/ > m_name_to_ID;
};
