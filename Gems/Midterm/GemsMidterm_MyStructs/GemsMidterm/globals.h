...
extern cCurtArray< cMesh* > g_vec_pMeshes;
extern cCurtArray< cMesh* > g_vec_pMeshesTransparency;
...
extern cCurtMap<std::string, GLint > g_uniformLocations;
...
#define Windows_Context_Menu_Usage_Custom
